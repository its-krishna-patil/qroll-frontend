...
<html lang="en">
  ...
  >
    <header class="flex flex-wrap items-center justify-between border-b border-[#243e47] px-4 sm:px-6 py-4">
      ...
      <nav class="flex flex-wrap justify-center gap-4 text-sm font-medium mt-2 md:mt-0 w-full sm:w-auto">
        <a href="#">Dashboard</a>
        <a href="#">Classes</a>
        <a href="#">Attendance</a>
        <a href="#">Profile</a>
      </nav>
      <div class="flex justify-center sm:justify-end items-center gap-3 mt-2 md:mt-0 w-full sm:w-auto">
        <button class="h-9 w-9 flex items-center justify-center rounded-full bg-[#243e47]">
          <svg
    ...
    <main class="flex-1 px-4 sm:px-6 py-6 max-w-4xl mx-auto w-full">
      <div class="mb-6 text-center sm:text-left">
        <h1 class="text-2xl sm:text-3xl font-bold">Hi, Krish 👋</h1>
        <p class="text-sm text-[#93bac8] mt-1">Today is Monday, August 14th</p>
      </div>

      <div class="mb-6 flex justify-center">
        <button
          class="flex items-center gap-2 px-5 py-3 bg-[#19b2e5] text-[#111e22] rounded-full font-bold text-sm sm:text-base shadow hover:opacity-90 transition"
          onclick="alert('QR scan triggered!')"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="22"
      ...
      <section class="rounded-xl bg-[#1a2c32] p-4 flex flex-col sm:flex-row gap-4 items-center">
        <p class="flex-1 text-center sm:text-left text-sm sm:text-base font-bold">
          Attendance: 11/12 classes | 92%
        </p>
        <div
          class="aspect-video w-full sm:w-1/2 rounded-xl bg-cover bg-center"
