...
const StudentDashboard = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[#111e22] text-white font-['Lexend','Noto Sans',sans-serif]"
    >
      {/* Header */}
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#93bac8] mt-1">Today is {today}</p>
        </div>

        <div className="mb-6 flex justify-center">
          <button className="flex items-center gap-2 px-5 py-2.5 bg-[#19b2e5] text-[#111e22] rounded-full font-bold text-sm sm:text-base">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
        ...
        <div className="bg-[#1a2c32] rounded-xl p-4 flex flex-col sm:flex-row gap-4 items-center">
          <p className="text-sm sm:text-base font-bold flex-1">
